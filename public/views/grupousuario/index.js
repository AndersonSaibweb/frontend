...
function getAllGrupoUsuario() {
  if (JSON.parse(localStorage.getItem("user")) != null) {
    ajax(
      _BASE_URL + _EP_GET_ALL_GRUPOUSUARIO,
      "GET",
      {},
      function (res) {
        if (res.length) {
          ...
          $("#grupoUsuarioList").children().remove();
          $("#grupoUsuarioList").html("");
          ...
          res.forEach((element) => {
            ...
            item = `<tr>
                            ...
                            <td style="width: 70px" class="project-actions text-right">
                                    ...
                                    <a href="create.html?id=${element.id}" class="btn btn-info btn-sm" href="#">
...
deleteGrupoUsuario = (id) => {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      if (JSON.parse(localStorage.getItem("user")) != null) {
        ajax(
          _BASE_URL + _EP_GET_ID_GRUPOUSUARIO + id,
          "DELETE",
          {},
          function (res) {
            getAllGrupoUsuario();
            Swal.fire("Excluido!", "Registro excluido com Sucesso.", "success");
          },
          JSON.parse(localStorage.getItem("user")).accessToken
        );
      }
